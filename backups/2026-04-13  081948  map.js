...
const MapModule = (function() {
  ...
  function updateBubbleColors() {
    ...
    var palette = filtered ? BUBBLE_COLOR_FILTERED : BUBBLE_COLOR_DEFAULT;
    var emissive = filtered ? 1 : 0;
    if (SKYBUBBLE_FILTER_COLOR_ENABLED && map.getLayer(SKYBUBBLE_LAYER_ID)) {
      map.setPaintProperty(SKYBUBBLE_LAYER_ID, 'circle-color', palette);
      map.setPaintProperty(SKYBUBBLE_LAYER_ID, 'circle-emissive-strength', emissive);
    }
    if (GROUNDBUBBLE_FILTER_COLOR_ENABLED && map.getLayer(GROUNDBUBBLE_LAYER_ID)) {
      map.setPaintProperty(GROUNDBUBBLE_LAYER_ID, 'circle-color', palette);
      map.setPaintProperty(GROUNDBUBBLE_LAYER_ID, 'circle-emissive-strength', emissive);
    }
  }
