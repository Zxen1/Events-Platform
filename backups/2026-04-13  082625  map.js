  ...
  function updateBubbleColors() {
    ...
    if (filtered) {
      if (SKYBUBBLE_FILTER_COLOR_ENABLED && map.getLayer(SKYBUBBLE_LAYER_ID)) {
        ...
        map.setPaintProperty(SKYBUBBLE_LAYER_ID, 'circle-stroke-emissive-strength', 0);
      }
      if (GROUNDBUBBLE_FILTER_COLOR_ENABLED && map.getLayer(GROUNDBUBBLE_LAYER_ID)) {
        ...
        map.setPaintProperty(GROUNDBUBBLE_LAYER_ID, 'circle-stroke-emissive-strength', 0);
      }
    } else {
      if (SKYBUBBLE_FILTER_COLOR_ENABLED && map.getLayer(SKYBUBBLE_LAYER_ID)) {
        map.setPaintProperty(SKYBUBBLE_LAYER_ID, 'circle-color', BUBBLE_COLOR_DEFAULT);
        map.setPaintProperty(SKYBUBBLE_LAYER_ID, 'circle-emissive-strength', undefined);
        map.setPaintProperty(SKYBUBBLE_LAYER_ID, 'circle-stroke-emissive-strength', undefined);
      }
      if (GROUNDBUBBLE_FILTER_COLOR_ENABLED && map.getLayer(GROUNDBUBBLE_LAYER_ID)) {
        map.setPaintProperty(GROUNDBUBBLE_LAYER_ID, 'circle-color', BUBBLE_COLOR_DEFAULT);
        map.setPaintProperty(GROUNDBUBBLE_LAYER_ID, 'circle-emissive-strength', undefined);
        map.setPaintProperty(GROUNDBUBBLE_LAYER_ID, 'circle-stroke-emissive-strength', undefined);
      }
    }
  }
