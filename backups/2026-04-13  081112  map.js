...
const MapModule = (function() {
  ...
  function hasActiveFilters() {
    try {
      ...
      return !!(f.keyword || f.minPrice || f.maxPrice || f.dateStart || f.dateEnd
  ...
  function updateBubbleColors() {
    if (!map) return;
    var _filtersOn = hasActiveFilters();
    console.error('[BubbleColor] hasActiveFilters=' + _filtersOn + ', skyLayer=' + !!map.getLayer(SKYBUBBLE_LAYER_ID) + ', groundLayer=' + !!map.getLayer(GROUNDBUBBLE_LAYER_ID));
    var palette = _filtersOn ? BUBBLE_COLOR_FILTERED : BUBBLE_COLOR_DEFAULT;
