  ...
  <script>
    (function(){
      ...
      if (consent === 'accepted') {
        ...
        s.async = true;
        s.src = 'https://www.googletagmanager.com/gtag/js?id=G-K1FG6B44LF';
                ...
                <form id="memberProfileEditForm" class="member-profile-edit" autocomplete="off">
                  ...
                  <div class="member-profile-edit-row">
                    ...
                    <div id="member-profile-more-menu" class="member-profile-more-menu" hidden>
                      ...
                      <button type="button" id="member-profile-restore-btn" class="member-profile-more-item member-profile-more-restore" style="display:none">
...
<div id="cookieBanner" class="cookie-banner" style="display:none" role="banner" aria-label="Cookie consent">
  <span class="cookie-banner-text">This site uses cookies for analytics. <a href="/?privacy" class="cookie-banner-link" id="cookiePrivacyLink">Privacy Policy</a></span>
  <div class="cookie-banner-buttons">
    <button class="cookie-accept button-class-2f" type="button">Accept</button>
    <button class="cookie-decline button-class-2f" type="button">Decline</button>
  </div>
</div>
<script>
(function(){
  ...
  document.getElementById('cookiePrivacyLink').addEventListener('click', function(e){
    e.preventDefault();
    if (window.WelcomeModalComponent) WelcomeModalComponent.openToChapter('privacy-policy');
  });
})();
</script>
</body>
