...
function fail($code, $msg) {
  if ($code >= 500) {
    global $mysqli, $memberRole, $memberId;
    $action = $GLOBALS['FUNMAP_GATEWAY_ACTION'] ?? 'delete-post';
    if ($mysqli instanceof mysqli) logSiteError($mysqli, $action, $msg, (int)($memberId ?? 0), (string)($memberRole ?? ''));
  }
