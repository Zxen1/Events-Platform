...
--
-- Host: localhost:3306
-- Generation Time: Dec 16, 2025 at 12:12 AM
...
(12, 'icon_folder', 'assets/category-icons', 'string', 'Folder path for category/subcategory icons', '2025-11-13 16:17:10', '2025-12-15 13:07:59'),
...
(5, 1, 'What\'s On', 'Live Sport', 'live-sport', '1,2,12,15', 'Title, Description, Images, Event Details', '1,1,1,1', NULL, NULL, NULL, NULL, '5', 0, 'assets/category-icons/whats-on-orange.svg', '#E74C3C', 'Events', NULL, '2025-10-29 12:32:47', '2025-12-15 13:12:37'),
(6, 1, 'What\'s On', 'Venues', 'venues', '1,2,12,9', 'Title, Description, Images, Address', '1,1,1,1', NULL, NULL, NULL, NULL, '7', 0, 'assets/category-icons/for-hire-green.svg', '#E74C3C', 'General', 'Entries Menu shows items/jobs/services/etc. Single entry: displays entry directly. Multi-entry: default view is About landing page (overview, not specific entry) until user selects an entry from the menu. Clicking entry changes summary info and may auto-switch image. Up to 10 images per entry. Venue menu + Entries menu.', '2025-10-29 12:32:47', '2025-12-15 13:12:37'),
(7, 1, 'What\'s On', 'Other Events', 'other-events', '1,2,12,15', 'Title, Description, Images, Event Details', '1,1,1,1', NULL, NULL, NULL, NULL, '6', 0, 'assets/category-icons/whats-on-gray.svg', '#E74C3C', 'Events', NULL, '2025-10-29 12:32:47', '2025-12-15 13:12:37'),
(8, 1, 'What\'s On', 'Festivals', 'festivals', '1,2,12,15', 'Title, Description, Images, Event Details', '1,1,1,1', NULL, NULL, NULL, NULL, '8', 0, 'assets/category-icons/whats-on-red.svg', '#E74C3C', 'Events', NULL, '2025-12-14 13:12:42', '2025-12-15 13:12:37'),
(9, 1, 'What\'s On', 'Markets', 'markets', '1,2,12,15', 'Title, Description, Images, Event Details', '1,1,1,1', NULL, NULL, NULL, NULL, '9', 0, 'assets/category-icons/whats-on-teal.svg', '#E74C3C', 'Events', NULL, '2025-12-14 13:12:42', '2025-12-15 13:12:37'),
...
(1033, 'live-gigs', 'text-box', 'Text Box (editable)', NULL, 'eg. Diamonds and Pearls', 'Write stuff here.', '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1034, 'test-subcategory', 'text-box', 'Textify!', NULL, NULL, NULL, '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1035, 'test-subcategory', 'text-area', 'Write an Essay', NULL, NULL, NULL, '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1036, 'test-subcategory', 'dropdown', 'Droppable', '[\"I Cant\",\"Do That\",\"Dave\"]', NULL, NULL, '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1037, 'test-subcategory', 'radio', 'Radiothon', '[\"Wake Me Up\",\"Before You\",\"Go Go\"]', NULL, NULL, '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1038, 'test-2-subcategory', 'text-area', 'hlhlhText Area Name 2', NULL, 'Field Placeholder 2', 'Field Placeholder 2', '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1039, 'test-2-subcategory', 'dropdown', 'Dropdown Name 2', '[\"Option 1\",\"Option 2\",\"Option 3\"]', 'Field Placeholder 2', 'Field Placeholder 2', '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1040, 'test-2-subcategory', 'text-box', 'Text Box (editable)', NULL, 'eg. Diamonds and Pearls', 'Write stuff here.', '2025-12-15 13:08:00', '2025-12-15 13:08:00'),
(1041, 'test-2-subcategory', 'radio', 'Radicvcvvo Toggle (editable)', '[\"Four\",\"Five\",\"Six\"]', 'Four,Five,Six', 'Choose one option from the radio buttons. Only one selection is allowed.', '2025-12-15 13:08:00', '2025-12-15 13:08:00');
...
--
ALTER TABLE `admin_settings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6497;
