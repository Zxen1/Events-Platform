...
(29, 'cm.svg', 'XAF', 'Central African CFA', 'FCFA', 'right', '.', 0, '', 29, 1),
(30, 'nc.svg', 'XPF', 'CFP Franc', '₣', 'right', '.', 0, ',', 30, 1),
(31, 'cl.svg', 'CLP', 'Chilean Peso', '$', 'right', ',', 0, '.', 31, 1),
(32, 'cn.svg', 'CNY', 'Chinese Yuan', '¥', 'left', '.', 2, ',', 32, 1),
(33, 'co.svg', 'COP', 'Colombian Peso', '$', 'right', ',', 2, '.', 33, 1),
(34, 'km.svg', 'KMF', 'Comorian Franc', 'CF', 'left', '.', 0, ',', 34, 1),
(35, 'cd.svg', 'CDF', 'Congolese Franc', 'FC', 'right', '.', 2, ',', 35, 1),
(36, 'cr.svg', 'CRC', 'Costa Rican Colon', '₡', 'right', '.', 2, ',', 36, 1),
(37, 'hr.svg', 'HRK', 'Croatian Kuna', 'kn', 'right', ',', 2, '.', 37, 1),
(38, 'cu.svg', 'CUP', 'Cuban Peso', '$', 'right', '.', 2, ',', 38, 1),
(39, 'cz.svg', 'CZK', 'Czech Koruna', 'Kč', 'right', ',', 2, '.', 39, 1),
(40, 'dk.svg', 'DKK', 'Danish Krone', 'kr', 'right', ',', 2, '.', 40, 1),
(41, 'dj.svg', 'DJF', 'Djiboutian Franc', 'Fdj', 'left', '.', 0, ',', 41, 1),
(42, 'ca.svg', 'CAD', 'Dollar canadien ($ après)', '$', 'right', ',', 2, '', 42, 1),
...
(48, 'eu.svg', 'EUR', 'Euro', '€', 'right', ',', 2, '.', 48, 1),
(49, 'eu.svg', 'EUR', 'Euro (€ before)', '€', 'left', ',', 2, '.', 49, 1),
...
(120, 'ch.svg', 'CHF', 'Schweizer Franken (vor)', 'CHF', 'left', '.', 2, '\'', 120, 1),
(121, 'rs.svg', 'RSD', 'Serbian Dinar', 'дин.', 'right', ',', 2, '.', 121, 1),
(122, 'sc.svg', 'SCR', 'Seychellois Rupee', '₨', 'right', '.', 2, ',', 122, 1),
(123, 'sl.svg', 'SLL', 'Sierra Leonean Leone', 'Le', 'left', '.', 2, ',', 123, 1),
(124, 'sg.svg', 'SGD', 'Singapore Dollar', '$', 'left', '.', 2, ',', 124, 1),
(125, 'sb.svg', 'SBD', 'Solomon Islands Dollar', '$', 'left', '.', 2, ',', 125, 1),
(126, 'so.svg', 'SOS', 'Somali Shilling', 'S', 'right', '.', 2, ',', 126, 1),
(127, 'za.svg', 'ZAR', 'South African Rand', 'R', 'left', '.', 2, ',', 127, 1),
(128, 'kr.svg', 'KRW', 'South Korean Won', '₩', 'right', '.', 0, ',', 128, 1),
(129, 'ss.svg', 'SSP', 'South Sudanese Pound', '£', 'left', '.', 2, ',', 129, 1),
(130, 'lk.svg', 'LKR', 'Sri Lankan Rupee', 'Rs', 'right', '.', 2, ',', 130, 1),
(131, 'sd.svg', 'SDG', 'Sudanese Pound', 'ج.س.', 'right', '.', 2, ',', 131, 1),
(132, 'sr.svg', 'SRD', 'Surinamese Dollar', '$', 'left', '.', 2, ',', 132, 1),
(133, 'sz.svg', 'SZL', 'Swazi Lilangeni', 'E', 'right', '.', 2, ',', 133, 1),
(134, 'se.svg', 'SEK', 'Swedish Krona', 'kr', 'right', ',', 2, '.', 134, 1),
(135, 'ch.svg', 'CHF', 'Swiss Franc', 'CHF', 'right', '.', 2, '\'', 135, 1),
