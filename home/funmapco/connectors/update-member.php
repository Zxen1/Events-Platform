...
$stmt = $mysqli->prepare('SELECT id, email, display_name, password_hash FROM members WHERE id=? AND email=? LIMIT 1');
...
$sql = 'UPDATE members SET ' . implode(', ', $updates) . ' WHERE id=? AND email=? LIMIT 1';
$types .= 'is';
$vals[] = $id;
$vals[] = $email;
