    ...
    function buildFieldset(fieldData, options) {
        ...
        switch (key) {
            ...
            case 'location': // legacy support
                ...
                addrLatInput.className = 'fieldset-lat component-locationwallpaper-lat';
                var addrLngInput = document.createElement('input');
                addrLngInput.type = 'hidden';
                addrLngInput.className = 'fieldset-lng component-locationwallpaper-lng';
            ...
            case 'city':
                ...
                cityLatInput.className = 'fieldset-lat component-locationwallpaper-lat';
                var cityLngInput = document.createElement('input');
                cityLngInput.type = 'hidden';
                cityLngInput.className = 'fieldset-lng component-locationwallpaper-lng';
            ...
            case 'venue':
                ...
                smartLatInput.className = 'fieldset-lat component-locationwallpaper-lat';
                var smartLngInput = document.createElement('input');
                smartLngInput.type = 'hidden';
                smartLngInput.className = 'fieldset-lng component-locationwallpaper-lng';
