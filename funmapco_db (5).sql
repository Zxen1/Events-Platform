...
--
-- Host: localhost:3306
-- Generation Time: Dec 08, 2025 at 05:24 AM
...
(75, 'phone-prefix', '+1', '🇺🇸 +1 United States', 1, 1),
(76, 'phone-prefix', '+1', '🇨🇦 +1 Canada', 2, 1),
(77, 'phone-prefix', '+44', '🇬🇧 +44 United Kingdom', 3, 1),
(78, 'phone-prefix', '+61', '🇦🇺 +61 Australia', 4, 1),
(79, 'phone-prefix', '+64', '🇳🇿 +64 New Zealand', 5, 1),
(80, 'phone-prefix', '+81', '🇯🇵 +81 Japan', 6, 1),
(81, 'phone-prefix', '+65', '🇸🇬 +65 Singapore', 7, 1),
(82, 'phone-prefix', '+852', '🇭🇰 +852 Hong Kong', 8, 1),
(83, 'phone-prefix', '+46', '🇸🇪 +46 Sweden', 9, 1),
(84, 'phone-prefix', '+47', '🇳🇴 +47 Norway', 10, 1),
(85, 'phone-prefix', '+45', '🇩🇰 +45 Denmark', 11, 1),
(86, 'phone-prefix', '+48', '🇵🇱 +48 Poland', 12, 1),
(87, 'phone-prefix', '+52', '🇲🇽 +52 Mexico', 13, 1),
(88, 'phone-prefix', '+55', '🇧🇷 +55 Brazil', 14, 1),
(89, 'phone-prefix', '+91', '🇮🇳 +91 India', 15, 1),
(90, 'phone-prefix', '+27', '🇿🇦 +27 South Africa', 16, 1),
(91, 'phone-prefix', '+86', '🇨🇳 +86 China', 17, 1),
(92, 'phone-prefix', '+82', '🇰🇷 +82 South Korea', 18, 1),
(93, 'phone-prefix', '+886', '🇹🇼 +886 Taiwan', 19, 1),
(94, 'phone-prefix', '+66', '🇹🇭 +66 Thailand', 20, 1),
(95, 'phone-prefix', '+63', '🇵🇭 +63 Philippines', 21, 1),
(96, 'phone-prefix', '+62', '🇮🇩 +62 Indonesia', 22, 1),
(97, 'phone-prefix', '+60', '🇲🇾 +60 Malaysia', 23, 1),
(98, 'phone-prefix', '+84', '🇻🇳 +84 Vietnam', 24, 1),
(99, 'phone-prefix', '+971', '🇦🇪 +971 UAE', 25, 1),
(100, 'phone-prefix', '+966', '🇸🇦 +966 Saudi Arabia', 26, 1),
(101, 'phone-prefix', '+974', '🇶🇦 +974 Qatar', 27, 1),
(102, 'phone-prefix', '+965', '🇰🇼 +965 Kuwait', 28, 1),
(103, 'phone-prefix', '+973', '🇧🇭 +973 Bahrain', 29, 1),
(104, 'phone-prefix', '+968', '🇴🇲 +968 Oman', 30, 1),
(105, 'phone-prefix', '+972', '🇮🇱 +972 Israel', 31, 1),
(106, 'phone-prefix', '+420', '🇨🇿 +420 Czech Republic', 32, 1),
(107, 'phone-prefix', '+36', '🇭🇺 +36 Hungary', 33, 1),
(108, 'phone-prefix', '+40', '🇷🇴 +40 Romania', 34, 1),
(109, 'phone-prefix', '+359', '🇧🇬 +359 Bulgaria', 35, 1),
(110, 'phone-prefix', '+385', '🇭🇷 +385 Croatia', 36, 1),
(111, 'phone-prefix', '+354', '🇮🇸 +354 Iceland', 37, 1),
(112, 'phone-prefix', '+7', '🇷🇺 +7 Russia', 38, 1),
(113, 'phone-prefix', '+380', '🇺🇦 +380 Ukraine', 39, 1),
(114, 'phone-prefix', '+90', '🇹🇷 +90 Turkey', 40, 1),
(115, 'phone-prefix', '+56', '🇨🇱 +56 Chile', 41, 1),
(116, 'phone-prefix', '+57', '🇨🇴 +57 Colombia', 42, 1),
(117, 'phone-prefix', '+54', '🇦🇷 +54 Argentina', 43, 1),
(118, 'phone-prefix', '+51', '🇵🇪 +51 Peru', 44, 1),
(119, 'phone-prefix', '+598', '🇺🇾 +598 Uruguay', 45, 1),
(120, 'phone-prefix', '+591', '🇧🇴 +591 Bolivia', 46, 1),
(121, 'phone-prefix', '+595', '🇵🇾 +595 Paraguay', 47, 1),
(122, 'phone-prefix', '+58', '🇻🇪 +58 Venezuela', 48, 1),
(123, 'phone-prefix', '+1', '🇩🇴 +1 Dominican Republic', 49, 1),
(124, 'phone-prefix', '+1', '🇯🇲 +1 Jamaica', 50, 1),
(125, 'phone-prefix', '+1', '🇹🇹 +1 Trinidad and Tobago', 51, 1),
(126, 'phone-prefix', '+502', '🇬🇹 +502 Guatemala', 52, 1),
(127, 'phone-prefix', '+506', '🇨🇷 +506 Costa Rica', 53, 1),
(128, 'phone-prefix', '+507', '🇵🇦 +507 Panama', 54, 1),
(129, 'phone-prefix', '+234', '🇳🇬 +234 Nigeria', 55, 1),
(130, 'phone-prefix', '+20', '🇪🇬 +20 Egypt', 56, 1),
(131, 'phone-prefix', '+254', '🇰🇪 +254 Kenya', 57, 1),
(132, 'phone-prefix', '+233', '🇬🇭 +233 Ghana', 58, 1),
(133, 'phone-prefix', '+255', '🇹🇿 +255 Tanzania', 59, 1),
(134, 'phone-prefix', '+256', '🇺🇬 +256 Uganda', 60, 1),
(135, 'phone-prefix', '+212', '🇲🇦 +212 Morocco', 61, 1),
(136, 'phone-prefix', '+216', '🇹🇳 +216 Tunisia', 62, 1),
(137, 'phone-prefix', '+92', '🇵🇰 +92 Pakistan', 63, 1),
(138, 'phone-prefix', '+880', '🇧🇩 +880 Bangladesh', 64, 1),
(139, 'phone-prefix', '+94', '🇱🇰 +94 Sri Lanka', 65, 1),
(140, 'phone-prefix', '+977', '🇳🇵 +977 Nepal', 66, 1),
(141, 'phone-prefix', '+95', '🇲🇲 +95 Myanmar', 67, 1),
(142, 'phone-prefix', '+679', '🇫🇯 +679 Fiji', 68, 1),
(143, 'phone-prefix', '+675', '🇵🇬 +675 Papua New Guinea', 69, 1),
(144, 'phone-prefix', '+33', '🇫🇷 +33 France', 70, 1),
(145, 'phone-prefix', '+49', '🇩🇪 +49 Germany', 71, 1),
(146, 'phone-prefix', '+39', '🇮🇹 +39 Italy', 72, 1),
(147, 'phone-prefix', '+34', '🇪🇸 +34 Spain', 73, 1),
(148, 'phone-prefix', '+31', '🇳🇱 +31 Netherlands', 74, 1),
(149, 'phone-prefix', '+32', '🇧🇪 +32 Belgium', 75, 1),
(150, 'phone-prefix', '+41', '🇨🇭 +41 Switzerland', 76, 1),
(151, 'phone-prefix', '+43', '🇦🇹 +43 Austria', 77, 1),
(152, 'phone-prefix', '+351', '🇵🇹 +351 Portugal', 78, 1),
(153, 'phone-prefix', '+353', '🇮🇪 +353 Ireland', 79, 1),
(154, 'phone-prefix', '+358', '🇫🇮 +358 Finland', 80, 1),
(155, 'phone-prefix', '+30', '🇬🇷 +30 Greece', 81, 1);
