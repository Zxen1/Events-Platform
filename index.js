...
async function ensureMapboxCssFor(container) {
  ...
  (function(){
    ...
    if(typeof window !== 'undefined'){
      window.categorySelection = selection;
    }
...
function makePosts(){
  ...
  return out;
    ...
    if(typeof window !== 'undefined'){
      window.categoryControllers = categoryControllers;
      window.allSubcategoryKeys = allSubcategoryKeys;
    }
...
function requestClosePanel(m){
  if(m){
    const adminManager = window.adminPanelChangeManager;
    if(m.id === 'adminPanel' && adminManager && typeof adminManager.handlePanelClose === 'function' && adminManager.handlePanelClose(m)){
      return;
    }
...
function handleEsc(){
  ...
  if(top instanceof Element){
    const adminManager = window.adminPanelChangeManager;
    if(top.id === 'adminPanel' && adminManager && typeof adminManager.handleEscape === 'function' && adminManager.handleEscape(top)){
      return;
    }
