...
const __NOUN = ["Symphony","Market","Carnival","Showcase","Assembly","Parade","Salon","Summit","Expo","SoirÃ©e","Revue","Collective","Fair","Gathering","Series","Retrospective","Circuit","Sessions","Weekender","Festival","Bazaar","Program","Tableau","Odyssey","Forum","Mosaic","Canvas","Relay","Drift","Workshop","Lab"];
...
function uniqueTitle(seed, cityName, idx){
  ...
  const makeTitle = (r)=>{
    const templates = [
      ...
      ()=> `${pickFrom(r, ARTISTS)} â€” ${pickFrom(r, TOUR_TAGS)}`,
    ...
    if ((r()%4)===0) t += ` â€” ${pickFrom(r, PROMOS)}`;
...
(function(){
  ...
  if(memberCreateSection){
    ...
    const loadingMessage = 'Loading form fieldsâ€¦';
    const fetchErrorMessage = 'We couldnâ€™t load the latest form fields. You can continue with the defaults for now.';
