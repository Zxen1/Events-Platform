  ...
  */
  ...
  function setupScrollHeightLock(scrollEl, opts) {
    ...
    function applyScrollStateSlackScrolling() {
      ...
      // Do not change slack size during scrolling (prevents visible resize/jumps).
    }
    ...
    function lock() {
      ...
      var h = scrollEl.clientHeight || 0;
      if (h <= 0) return;
      // If the user is in the middle of a click, do NOT apply the scrolling lock or slack collapse.
      // This is the anchor protection window.
