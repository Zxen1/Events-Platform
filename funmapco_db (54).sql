...
--
-- Host: localhost:3306
-- Generation Time: Jan 16, 2026 at 07:57 AM
...
(1, 'af.svg', 'AFN', 'Afghan Afghani', '؋', 'left', '.', 2, ',', 1, 1),
(2, 'al.svg', 'ALL', 'Albanian Lek', 'L', 'left', '.', 2, ',', 2, 1),
(3, 'dz.svg', 'DZD', 'Algerian Dinar', 'د.ج', 'left', '.', 2, ',', 3, 1),
(4, 'ao.svg', 'AOA', 'Angolan Kwanza', 'Kz', 'left', '.', 2, ',', 4, 1),
(5, 'ar.svg', 'ARS', 'Argentine Peso', '$', 'left', ',', 2, '.', 5, 1),
(6, 'am.svg', 'AMD', 'Armenian Dram', '֏', 'left', '.', 2, ',', 6, 1),
(7, 'aw.svg', 'AWG', 'Aruban Florin', 'ƒ', 'left', '.', 2, ',', 7, 1),
(8, 'au.svg', 'AUD', 'Australian Dollar', '$', 'left', '.', 2, ',', 8, 1),
(9, 'az.svg', 'AZN', 'Azerbaijani Manat', '₼', 'left', '.', 2, ',', 9, 1),
(10, 'bs.svg', 'BSD', 'Bahamian Dollar', '$', 'left', '.', 2, ',', 10, 1),
(11, 'bh.svg', 'BHD', 'Bahraini Dinar', '.د.ب', 'left', '.', 3, ',', 11, 1),
(12, 'bd.svg', 'BDT', 'Bangladeshi Taka', '৳', 'left', '.', 2, ',', 12, 1),
(13, 'bb.svg', 'BBD', 'Barbadian Dollar', '$', 'left', '.', 2, ',', 13, 1),
(14, 'by.svg', 'BYN', 'Belarusian Ruble', 'Br', 'left', ',', 2, '.', 14, 1),
(15, 'bz.svg', 'BZD', 'Belize Dollar', '$', 'left', '.', 2, ',', 15, 1),
(16, 'bm.svg', 'BMD', 'Bermudian Dollar', '$', 'left', '.', 2, ',', 16, 1),
(17, 'bt.svg', 'BTN', 'Bhutanese Ngultrum', 'Nu.', 'left', '.', 2, ',', 17, 1),
(18, 'bo.svg', 'BOB', 'Bolivian Boliviano', 'Bs.', 'left', ',', 2, '.', 18, 1),
(19, 'ba.svg', 'BAM', 'Bosnian Mark', 'KM', 'left', ',', 2, '.', 19, 1),
(20, 'bw.svg', 'BWP', 'Botswana Pula', 'P', 'left', '.', 2, ',', 20, 1),
(21, 'br.svg', 'BRL', 'Brazilian Real', 'R$', 'left', ',', 2, '.', 21, 1),
(22, 'bn.svg', 'BND', 'Brunei Dollar', '$', 'left', '.', 2, ',', 22, 1),
(23, 'bg.svg', 'BGN', 'Bulgarian Lev', 'лв', 'left', ',', 2, '.', 23, 1),
(24, 'bi.svg', 'BIF', 'Burundian Franc', 'FBu', 'left', '.', 0, ',', 24, 1),
(25, 'kh.svg', 'KHR', 'Cambodian Riel', '៛', 'left', '.', 2, ',', 25, 1),
(26, 'ca.svg', 'CAD', 'Canadian Dollar', '$', 'left', '.', 2, ',', 26, 1),
(27, 'cv.svg', 'CVE', 'Cape Verdean Escudo', '$', 'left', '.', 2, ',', 27, 1),
(28, 'ky.svg', 'KYD', 'Cayman Islands Dollar', '$', 'left', '.', 2, ',', 28, 1),
(29, 'cm.svg', 'XAF', 'Central African CFA', 'FCFA', 'left', '.', 0, '', 29, 1),
(30, 'nc.svg', 'XPF', 'CFP Franc', '₣', 'left', '.', 0, ',', 30, 1),
(31, 'cl.svg', 'CLP', 'Chilean Peso', '$', 'left', ',', 0, '.', 31, 1),
(32, 'cn.svg', 'CNY', 'Chinese Yuan', '¥', 'left', '.', 2, ',', 32, 1),
(33, 'co.svg', 'COP', 'Colombian Peso', '$', 'left', ',', 2, '.', 33, 1),
(34, 'km.svg', 'KMF', 'Comorian Franc', 'CF', 'left', '.', 0, ',', 34, 1),
(35, 'cd.svg', 'CDF', 'Congolese Franc', 'FC', 'left', '.', 2, ',', 35, 1),
(36, 'cr.svg', 'CRC', 'Costa Rican Colon', '₡', 'left', '.', 2, ',', 36, 1),
(37, 'hr.svg', 'HRK', 'Croatian Kuna', 'kn', 'left', ',', 2, '.', 37, 1),
(38, 'cu.svg', 'CUP', 'Cuban Peso', '$', 'left', '.', 2, ',', 38, 1),
(39, 'cz.svg', 'CZK', 'Czech Koruna', 'Kč', 'left', ',', 2, '.', 39, 1),
(40, 'dk.svg', 'DKK', 'Danish Krone', 'kr', 'left', ',', 2, '.', 40, 1),
(41, 'dj.svg', 'DJF', 'Djiboutian Franc', 'Fdj', 'left', '.', 0, ',', 41, 1),
(42, 'do.svg', 'DOP', 'Dominican Peso', 'RD$', 'left', '.', 2, ',', 42, 1),
(43, 'eg.svg', 'EGP', 'Egyptian Pound', 'E£', 'left', '.', 2, ',', 43, 1),
(44, 'er.svg', 'ERN', 'Eritrean Nakfa', 'Nfk', 'left', '.', 2, ',', 44, 1),
(45, 'et.svg', 'ETB', 'Ethiopian Birr', 'Br', 'left', '.', 2, ',', 45, 1),
(46, 'eu.svg', 'EUR', 'Euro', '€', 'left', ',', 2, '.', 46, 1),
(47, 'fk.svg', 'FKP', 'Falkland Islands Pound', '£', 'left', '.', 2, ',', 47, 1),
(48, 'fj.svg', 'FJD', 'Fijian Dollar', '$', 'left', '.', 2, ',', 48, 1),
(49, 'gm.svg', 'GMD', 'Gambian Dalasi', 'D', 'left', '.', 2, ',', 49, 1),
(50, 'ge.svg', 'GEL', 'Georgian Lari', '₾', 'left', '.', 2, ',', 50, 1),
(51, 'gh.svg', 'GHS', 'Ghanaian Cedi', '₵', 'left', '.', 2, ',', 51, 1),
(52, 'gi.svg', 'GIP', 'Gibraltar Pound', '£', 'left', '.', 2, ',', 52, 1),
(53, 'gt.svg', 'GTQ', 'Guatemalan Quetzal', 'Q', 'left', '.', 2, ',', 53, 1),
(54, 'gn.svg', 'GNF', 'Guinean Franc', 'FG', 'left', '.', 0, ',', 54, 1),
(55, 'gy.svg', 'GYD', 'Guyanese Dollar', '$', 'left', '.', 2, ',', 55, 1),
(56, 'ht.svg', 'HTG', 'Haitian Gourde', 'G', 'left', '.', 2, ',', 56, 1),
(57, 'hn.svg', 'HNL', 'Honduran Lempira', 'L', 'left', '.', 2, ',', 57, 1),
(58, 'hk.svg', 'HKD', 'Hong Kong Dollar', '$', 'left', '.', 2, ',', 58, 1),
(59, 'hu.svg', 'HUF', 'Hungarian Forint', 'Ft', 'left', ',', 2, '.', 59, 1),
(60, 'is.svg', 'ISK', 'Icelandic Krona', 'kr', 'left', '.', 0, ',', 60, 1),
(61, 'in.svg', 'INR', 'Indian Rupee', '₹', 'left', '.', 2, ',', 61, 1),
(62, 'id.svg', 'IDR', 'Indonesian Rupiah', 'Rp', 'left', ',', 2, '.', 62, 1),
(63, 'ir.svg', 'IRR', 'Iranian Rial', '﷼', 'left', '.', 2, ',', 63, 1),
(64, 'iq.svg', 'IQD', 'Iraqi Dinar', 'ع.د', 'left', '.', 3, ',', 64, 1),
(65, 'il.svg', 'ILS', 'Israeli Shekel', '₪', 'left', '.', 2, ',', 65, 1),
(66, 'jm.svg', 'JMD', 'Jamaican Dollar', '$', 'left', '.', 2, ',', 66, 1),
(67, 'jp.svg', 'JPY', 'Japanese Yen', '¥', 'left', '.', 0, ',', 67, 1),
(68, 'jo.svg', 'JOD', 'Jordanian Dinar', 'د.ا', 'left', '.', 3, ',', 68, 1),
(69, 'kz.svg', 'KZT', 'Kazakhstani Tenge', '₸', 'left', '.', 2, ',', 69, 1),
(70, 'ke.svg', 'KES', 'Kenyan Shilling', 'KSh', 'left', '.', 2, ',', 70, 1),
(71, 'kw.svg', 'KWD', 'Kuwaiti Dinar', 'د.ك', 'left', '.', 3, ',', 71, 1),
(72, 'kg.svg', 'KGS', 'Kyrgyzstani Som', 'с', 'left', '.', 2, ',', 72, 1),
(73, 'la.svg', 'LAK', 'Lao Kip', '₭', 'left', '.', 2, ',', 73, 1),
(74, 'lb.svg', 'LBP', 'Lebanese Pound', 'ل.ل', 'left', '.', 2, ',', 74, 1),
(75, 'ls.svg', 'LSL', 'Lesotho Loti', 'L', 'left', '.', 2, ',', 75, 1),
(76, 'lr.svg', 'LRD', 'Liberian Dollar', '$', 'left', '.', 2, ',', 76, 1),
(77, 'ly.svg', 'LYD', 'Libyan Dinar', 'ل.د', 'left', '.', 3, ',', 77, 1),
(78, 'mo.svg', 'MOP', 'Macanese Pataca', 'MOP$', 'left', '.', 2, ',', 78, 1),
(79, 'mk.svg', 'MKD', 'Macedonian Denar', 'ден', 'left', ',', 2, '.', 79, 1),
(80, 'mg.svg', 'MGA', 'Malagasy Ariary', 'Ar', 'left', '.', 2, ',', 80, 1),
(81, 'mw.svg', 'MWK', 'Malawian Kwacha', 'MK', 'left', '.', 2, ',', 81, 1),
(82, 'my.svg', 'MYR', 'Malaysian Ringgit', 'RM', 'left', '.', 2, ',', 82, 1),
(83, 'mv.svg', 'MVR', 'Maldivian Rufiyaa', 'Rf', 'left', '.', 2, ',', 83, 1),
(84, 'mr.svg', 'MRU', 'Mauritanian Ouguiya', 'UM', 'left', '.', 2, ',', 84, 1),
(85, 'mu.svg', 'MUR', 'Mauritian Rupee', '₨', 'left', '.', 2, ',', 85, 1),
(86, 'mx.svg', 'MXN', 'Mexican Peso', '$', 'left', '.', 2, ',', 86, 1),
(87, 'md.svg', 'MDL', 'Moldovan Leu', 'L', 'left', ',', 2, '.', 87, 1),
(88, 'mn.svg', 'MNT', 'Mongolian Tugrik', '₮', 'left', '.', 2, ',', 88, 1),
(89, 'ma.svg', 'MAD', 'Moroccan Dirham', 'د.م.', 'left', '.', 2, ',', 89, 1),
(90, 'mz.svg', 'MZN', 'Mozambican Metical', 'MT', 'left', '.', 2, ',', 90, 1),
(91, 'mm.svg', 'MMK', 'Myanmar Kyat', 'K', 'left', '.', 2, ',', 91, 1),
(92, 'na.svg', 'NAD', 'Namibian Dollar', '$', 'left', '.', 2, ',', 92, 1),
(93, 'np.svg', 'NPR', 'Nepalese Rupee', '₨', 'left', '.', 2, ',', 93, 1),
(94, 'nz.svg', 'NZD', 'New Zealand Dollar', '$', 'left', '.', 2, ',', 94, 1),
(95, 'ni.svg', 'NIO', 'Nicaraguan Cordoba', 'C$', 'left', '.', 2, ',', 95, 1),
(96, 'ng.svg', 'NGN', 'Nigerian Naira', '₦', 'left', '.', 2, ',', 96, 1),
(97, 'kp.svg', 'KPW', 'North Korean Won', '₩', 'left', '.', 2, ',', 97, 1),
(98, 'no.svg', 'NOK', 'Norwegian Krone', 'kr', 'left', ',', 2, '.', 98, 1),
(99, 'om.svg', 'OMR', 'Omani Rial', 'ر.ع.', 'left', '.', 3, ',', 99, 1),
(100, 'pk.svg', 'PKR', 'Pakistani Rupee', '₨', 'left', '.', 2, ',', 100, 1),
(101, 'pa.svg', 'PAB', 'Panamanian Balboa', 'B/.', 'left', '.', 2, ',', 101, 1),
(102, 'pg.svg', 'PGK', 'Papua New Guinean Kina', 'K', 'left', '.', 2, ',', 102, 1),
(103, 'py.svg', 'PYG', 'Paraguayan Guarani', '₲', 'left', ',', 0, '.', 103, 1),
(104, 'pe.svg', 'PEN', 'Peruvian Sol', 'S/', 'left', ',', 2, '.', 104, 1),
(105, 'ph.svg', 'PHP', 'Philippine Peso', '₱', 'left', '.', 2, ',', 105, 1),
(106, 'pl.svg', 'PLN', 'Polish Zloty', 'zł', 'left', ',', 2, '.', 106, 1),
(107, 'gb.svg', 'GBP', 'Pound Sterling', '£', 'left', '.', 2, ',', 107, 1),
(108, 'qa.svg', 'QAR', 'Qatari Riyal', 'ر.ق', 'left', '.', 2, ',', 108, 1),
(109, 'ro.svg', 'RON', 'Romanian Leu', 'lei', 'left', ',', 2, '.', 109, 1),
(110, 'ru.svg', 'RUB', 'Russian Ruble', '₽', 'left', ',', 2, '.', 110, 1),
(111, 'rw.svg', 'RWF', 'Rwandan Franc', 'FRw', 'left', '.', 0, ',', 111, 1),
(112, 'ws.svg', 'WST', 'Samoan Tala', 'T', 'left', '.', 2, ',', 112, 1),
(113, 'sa.svg', 'SAR', 'Saudi Riyal', 'ر.س', 'left', '.', 2, ',', 113, 1),
(114, 'rs.svg', 'RSD', 'Serbian Dinar', 'дин.', 'left', ',', 2, '.', 114, 1),
(115, 'sc.svg', 'SCR', 'Seychellois Rupee', '₨', 'left', '.', 2, ',', 115, 1),
(116, 'sl.svg', 'SLL', 'Sierra Leonean Leone', 'Le', 'left', '.', 2, ',', 116, 1),
(117, 'sg.svg', 'SGD', 'Singapore Dollar', '$', 'left', '.', 2, ',', 117, 1),
(118, 'sb.svg', 'SBD', 'Solomon Islands Dollar', '$', 'left', '.', 2, ',', 118, 1),
(119, 'so.svg', 'SOS', 'Somali Shilling', 'S', 'left', '.', 2, ',', 119, 1),
(120, 'za.svg', 'ZAR', 'South African Rand', 'R', 'left', '.', 2, ',', 120, 1),
(121, 'kr.svg', 'KRW', 'South Korean Won', '₩', 'left', '.', 0, ',', 121, 1),
(122, 'ss.svg', 'SSP', 'South Sudanese Pound', '£', 'left', '.', 2, ',', 122, 1),
(123, 'lk.svg', 'LKR', 'Sri Lankan Rupee', 'Rs', 'left', '.', 2, ',', 123, 1),
(124, 'sd.svg', 'SDG', 'Sudanese Pound', 'ج.س.', 'left', '.', 2, ',', 124, 1),
(125, 'sr.svg', 'SRD', 'Surinamese Dollar', '$', 'left', '.', 2, ',', 125, 1),
(126, 'sz.svg', 'SZL', 'Swazi Lilangeni', 'E', 'left', '.', 2, ',', 126, 1),
(127, 'se.svg', 'SEK', 'Swedish Krona', 'kr', 'left', ',', 2, '.', 127, 1),
(128, 'ch.svg', 'CHF', 'Swiss Franc', 'CHF', 'left', '.', 2, '\'', 128, 1),
(129, 'sy.svg', 'SYP', 'Syrian Pound', '£', 'left', '.', 2, ',', 129, 1),
(130, 'tw.svg', 'TWD', 'Taiwan Dollar', 'NT$', 'left', '.', 2, ',', 130, 1),
(131, 'tj.svg', 'TJS', 'Tajikistani Somoni', 'SM', 'left', '.', 2, ',', 131, 1),
(132, 'tz.svg', 'TZS', 'Tanzanian Shilling', 'TSh', 'left', '.', 2, ',', 132, 1),
(133, 'th.svg', 'THB', 'Thai Baht', '฿', 'left', '.', 2, ',', 133, 1),
(134, 'to.svg', 'TOP', 'Tongan Paanga', 'T$', 'left', '.', 2, ',', 134, 1),
(135, 'tt.svg', 'TTD', 'Trinidad Dollar', '$', 'left', '.', 2, ',', 135, 1),
(136, 'tn.svg', 'TND', 'Tunisian Dinar', 'د.ت', 'left', '.', 3, ',', 136, 1),
(137, 'tr.svg', 'TRY', 'Turkish Lira', '₺', 'left', '.', 2, ',', 137, 1),
(138, 'tm.svg', 'TMT', 'Turkmenistani Manat', 'm', 'left', '.', 2, ',', 138, 1),
(139, 'ae.svg', 'AED', 'UAE Dirham', 'د.إ', 'left', '.', 2, ',', 139, 1),
(140, 'ug.svg', 'UGX', 'Ugandan Shilling', 'USh', 'left', '.', 0, ',', 140, 1),
(141, 'ua.svg', 'UAH', 'Ukrainian Hryvnia', '₴', 'left', ',', 2, '.', 141, 1),
(142, 'uy.svg', 'UYU', 'Uruguayan Peso', '$', 'left', ',', 2, '.', 142, 1),
(143, 'us.svg', 'USD', 'US Dollar', '$', 'left', '.', 2, ',', 143, 1),
(144, 'uz.svg', 'UZS', 'Uzbekistani Som', 'soʻm', 'left', '.', 2, ',', 144, 1),
(145, 'vu.svg', 'VUV', 'Vanuatu Vatu', 'VT', 'left', '.', 0, ',', 145, 1),
(146, 've.svg', 'VES', 'Venezuelan Bolivar', 'Bs.', 'left', ',', 2, '.', 146, 1),
(147, 'vn.svg', 'VND', 'Vietnamese Dong', '₫', 'left', ',', 0, '.', 147, 1),
(148, 'sn.svg', 'XOF', 'West African CFA', 'CFA', 'left', '.', 0, '', 148, 1),
(149, 'ye.svg', 'YER', 'Yemeni Rial', '﷼', 'left', '.', 2, ',', 149, 1),
(150, 'zm.svg', 'ZMW', 'Zambian Kwacha', 'ZK', 'left', '.', 2, ',', 150, 1),
(151, 'zw.svg', 'ZWL', 'Zimbabwean Dollar', '$', 'left', '.', 2, ',', 151, 1),
