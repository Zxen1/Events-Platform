...
### Infrastructure
q. [SCRIPT DONE] **Rate limiting** — before sending, check `emails_sent` for emails sent to the same address in the last 7 days; abort if over threshold. Cron trigger needed.
