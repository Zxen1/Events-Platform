...
$samples = [
  ...
  'reminder_report'   => '<p style="font-size:13px;font-weight:bold;color:#333;margin:0 0 10px;">Needs attention:</p><div style="margin:0 0 12px;"><p style="font-size:14px;color:#333;margin:0 0 2px;">Expires in 7 days · 9 Mar 2026</p><p style="font-size:13px;color:#888;margin:0;">Sydney Harbour New Year Fireworks Spectacular</p></div><div style="margin:0 0 12px;"><p style="font-size:14px;color:#333;margin:0 0 2px;">Expires in 10 days · 12 Mar 2026</p><p style="font-size:13px;color:#888;margin:0;">Jazz at the Rocks Annual Music Festival</p></div><div style="margin:0 0 12px;"><p style="font-size:14px;color:#333;margin:0 0 2px;">Expires in 13 days · 15 Mar 2026</p><p style="font-size:13px;color:#888;margin:0;">Bondi Beach Sunset Markets and Food Fair</p></div><div style="margin:0 0 24px;"><p style="font-size:14px;color:#333;margin:0 0 2px;">Scheduled for deletion in 6 days · 8 Mar 2026</p><p style="font-size:13px;color:#888;margin:0;">Little Havana Domino Park Community Night</p></div><p style="font-size:13px;font-weight:bold;color:#333;margin:0 0 10px;">Recently expired:</p><div style="margin:0 0 12px;"><p style="font-size:14px;color:#aaa;margin:0 0 2px;">Expired · 12 Feb 2026</p><p style="font-size:13px;color:#bbb;margin:0;">Melbourne International Comedy Festival Showcase</p></div><div style="margin:0 0 12px;"><p style="font-size:14px;color:#aaa;margin:0 0 2px;">Expired · 18 Feb 2026</p><p style="font-size:13px;color:#bbb;margin:0;">Circular Quay Summer Night Markets</p></div><div style="margin:0 0 24px;"><p style="font-size:14px;color:#aaa;margin:0 0 2px;">Expired · 20 Feb 2026</p><p style="font-size:13px;color:#bbb;margin:0;">Kings Cross Vintage and Antique Fair</p></div>',
];
?>
<!DOCTYPE html>
<html lang="en">
